              ...
              <div className="col-xl-6 col-lg-6 col-12">
                <div className="wpo-static-hero-inner">
                  <div data-swiper-parallax="300" className="slide-title">
                    <h2>
                      <span>Hello,</span>I am Tom.
                    </h2>
                  </div>
                  <div data-swiper-parallax="300" className="slide-sub-title">
                    <h5>SEO Professional</h5>
                  </div>
                  <div data-swiper-parallax="400" className="slide-text">
                    <p>Thanks for checking out my CV.</p>
                  </div>
        ...
        <div className="static-hero-img">
          <div className="static-hero-img-inner">
            <img
              ...
              alt="Tom Dawkins profile picture"
            />
            <div className="icon-1 floating-item">
              <img
                src="images/icon/screaming-frog-icon.png"
                alt="screaming frog icon"
              />
            </div>
            <div className="icon-2 floating-item">
              <img src="images/icon/chatgpt-icon.png" alt="chatgpt icon" />
            </div>
